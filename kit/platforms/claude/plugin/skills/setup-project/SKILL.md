...
name: setup-project
description: >
  Use when starting a brand new project in Claude Code - when the user says "create
...
Use `/coding-agent-kit:scan-project` to create docs, project `CLAUDE.md`, and any
