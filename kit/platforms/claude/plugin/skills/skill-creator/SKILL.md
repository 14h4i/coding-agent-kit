...
name: skill-creator
description: >
  Use when the user wants to create a new Claude Code skill, add a repo-scoped or
  personal workflow, or says "create a skill", "add a skill", or "I want
  Claude Code to know how to do X". Also use when another coding-agent-kit skill
...
- Repo-scoped (`.claude/skills/`) or personal (`~/.claude/skills/`)?
...
- Verify commands exist in project docs or `CLAUDE.md`.
