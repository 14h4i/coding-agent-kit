...
description: >
  Use before non-trivial creative or implementation work in Claude Code - adding a
...
After approval, use `/coding-agent-kit:write-plan` to produce the implementation
plan.
