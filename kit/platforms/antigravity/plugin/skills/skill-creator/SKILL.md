...
name: skill-creator
description: >
  Use when the user wants to create a new Antigravity skill, add a repo-scoped or
  personal workflow, or says "create a skill", "add a skill", or "I want
  Antigravity to know how to do X". Also use when another coding-agent-kit skill
...
- Workspace-scoped (`.agents/skills/`) or global (`~/.gemini/config/skills/`)?
...
- Verify commands exist in project docs, `.agents/rules/`, `GEMINI.md`, or `AGENTS.md`.
