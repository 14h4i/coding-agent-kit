...
name: setup-project
description: >
  Use when starting a brand new project in Antigravity - when the user says "create
...
Use the `scan-project` skill from this plugin to create docs, project Antigravity rules, and any
