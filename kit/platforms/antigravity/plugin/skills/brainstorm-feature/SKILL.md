...
description: >
  Use before non-trivial creative or implementation work in Antigravity - adding a
...
After approval, use the `write-plan` skill from this plugin to produce the implementation
plan.
